...
import { MORNING_BRIEFING_SYSTEM_PROMPT } from "./prompt.ts";
...
export function validateMorningBriefing(
  rawOutput: string,
  pkg: MorningBriefingPackage,
): ValidationResult {
  return validateInsight(rawOutput, pkg, {
    schema: loadSchema(),
    proseFieldsToScan: PROSE_FIELDS,
    promptText: MORNING_BRIEFING_SYSTEM_PROMPT,
  });
}
