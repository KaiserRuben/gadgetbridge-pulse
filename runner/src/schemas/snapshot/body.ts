import { BODY_FACTORS } from "../../confidence-weights.ts";
import {
  COMPARISON_TYPED,
...
/**
 * snapshot/body — strict JSON Schema (v2, dual-consumer).
 *
 ...
 * fields below.
 */
export const BodySnapshotSchema = {
  type: "object",
  ...
  properties: {
    ...
    // ── confidence ─────────────────────────────────────────────────────
    confidence: confidenceBlockSchema(BODY_FACTORS),
