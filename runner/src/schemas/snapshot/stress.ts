import { STRESS_FACTORS } from "../../confidence-weights.ts";
import {
  COMPARISON_TYPED,
...
/**
 * snapshot/stress — strict JSON Schema (v2, dual-consumer).
 *
 ...
 * fields below.
 */
export const StressSnapshotSchema = {
  type: "object",
  ...
  properties: {
    ...
    // ── confidence ─────────────────────────────────────────────────────
    confidence: confidenceBlockSchema(STRESS_FACTORS),
