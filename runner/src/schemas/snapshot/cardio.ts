import { CARDIO_FACTORS } from "../../confidence-weights.ts";
import {
  COMPARISON_TYPED,
...
/**
 * snapshot/cardio — strict JSON Schema (v2, dual-consumer).
 *
 ...
 * fields below.
 */
export const CardioSnapshotSchema = {
  type: "object",
  ...
  properties: {
    ...
    // ── confidence ─────────────────────────────────────────────────────
    confidence: confidenceBlockSchema(CARDIO_FACTORS),
