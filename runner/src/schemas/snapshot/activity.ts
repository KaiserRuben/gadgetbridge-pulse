import { ACTIVITY_FACTORS } from "../../confidence-weights.ts";
import {
  COMPARISON_TYPED,
...
/**
 * snapshot/activity — strict JSON Schema (v2, dual-consumer).
 *
...
export const ActivitySnapshotSchema = {
  ...
  properties: {
    ...
    // ── confidence ─────────────────────────────────────────────────────
    confidence: confidenceBlockSchema(ACTIVITY_FACTORS),
